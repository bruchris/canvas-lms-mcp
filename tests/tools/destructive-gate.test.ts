 ...
 * guarantee: the eight irreversible delete tools are never registered, so no
 ...
 * removing the wrong eight tools.
 */
 ...
 * `audience: 'educator'`, so the student role sees none of the eight and
