...
describe('ConversationsModule', () => {
  ...
  it('lists conversations', async () => {
    vi.spyOn(client, 'paginate').mockResolvedValueOnce([
      { id: 1, subject: 'Question', last_message: 'Hi', last_message_at: '2026-04-10T00:00:00Z', message_count: 2, participants: [{ id: 1, name: 'Alice' }] },
    ])
  ...
  it('sends a conversation', async () => {
    vi.spyOn(client, 'request').mockResolvedValueOnce([
      { id: 2, subject: 'Hello', last_message: 'Hi there', last_message_at: '2026-04-10T00:00:00Z', message_count: 1, participants: [] },
    ])
