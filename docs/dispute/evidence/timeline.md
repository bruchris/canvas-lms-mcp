...
- The squatter package was registered approximately 2h 19m before the bruchris v0.1.0 GitHub Release was published on npm, but after the underlying implementation was publicly committed to GitHub on 2026-04-10.
- The squatter package contains no source code, no tests, and no documentation — it is a stub that captured the namespace.
- `first-contact-email.md` and `npm-support-email.md` are maintained separately by the project maintainer.
